...
Koin projektin aikana oppineeni paljon AWS ympäristöstä ja sen toiminnasta, sekä opin entisestään node.js käyttöä yritysten myötä.
Minulla ei ollut pohjatietoa AWS ympäristöstä ja serverless frameworkista, tehtävään opetektava tiedon määrä oli alussa hieman päällepuskeva, mutta uskon että hallitsin tilanteen hyvin.

Kansioista löydätte muutaman valitun palan yrityksiäni ja lopullisen tehtävänantokansion.
